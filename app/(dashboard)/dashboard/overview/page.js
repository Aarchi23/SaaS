...
const StatCard = ({ label, value, icon: Icon }) => (
  <div className="bg-card px-5 py-4 rounded-2xl border border-border shadow-sm flex-1 min-w-50 hover:border-primary/20 transition-colors">
...
const RevenueChart = () => {
  ...
  return (
    <div className="bg-card p-8 rounded-2xl border border-border shadow-sm h-full flex flex-col min-h-100">
      <div className="flex justify-between items-start mb-10">
        ...
        <span className="bg-primary/10 text-primary text-[10px] font-black px-3 py-1.5 rounded-full flex items-center gap-1 uppercase tracking-wider">
...
const MarginChart = () => (
  <div className="bg-card p-8 rounded-2xl border border-border shadow-sm h-full flex flex-col items-center min-h-100">
...
const AuditPipeline = () => (
  <div className="bg-card p-8 rounded-2xl border border-border shadow-sm h-full flex flex-col min-h-75">
      ...
      {[1, 2, 3].map((i) => (
        <div key={i} className="flex items-center justify-between p-4 rounded-xl hover:bg-secondary/50 transition-colors cursor-pointer group">
          ...
          <div className="text-right font-black">
            ...
            <p className="text-[9px] text-primary uppercase tracking-widest mt-0.5">Internal Audit</p>
          </div>
        </div>
      ))}
    </div>
...
const GrowthForecast = () => (
  <div className="bg-foreground p-8 rounded-2xl shadow-2xl h-full flex flex-col justify-between overflow-hidden relative group border border-border min-h-75">
    ...
    <div className="pt-6 border-t border-muted/20 flex justify-between items-end relative z-10">
      ...
      <div className="bg-primary/20 text-primary text-[10px] font-black px-3 py-1.5 rounded-lg border border-primary/20 uppercase tracking-widest">+2.4%</div>
    </div>
  </div>
);
    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-wrap gap-10 py-8 border-t border-border">
        <div className="flex items-center gap-3 text-[10px] font-black text-muted-foreground uppercase tracking-widest">
          <div className="w-2.5 h-2.5 rounded-full bg-primary animate-pulse shadow-lg shadow-primary/20" />
